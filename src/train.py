...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights-folder', type=str, default="D:/DACN/dataset/Flickr30k/transformer_weights")
    parser.add_argument('--histories-folder', type=str, default="D:/DACN/dataset/Flickr30k/transformer_histories")
